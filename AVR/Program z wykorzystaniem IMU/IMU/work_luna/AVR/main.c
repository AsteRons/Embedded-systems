...
volatile uint8_t flaga;
	...
	for(;;) {
		...
		//Pobieranie danych UART
				...
				// Sterowanie komunikatów VBS -> Replika
		...
		if(tab[0] == 'G' )
		{
			...
			if(tab[0] == 'G' && tab[1]	==	' ' && tab[2] == 'L')
			{
				...
				if(tab[0] == 'G' && tab[1]	==	' ' && tab[2] == 'L' && tab[3] == '1')
				{
					tab[4]	=	uart_getc();
					if(tab[0] == 'G' && tab[1]	==	' ' && tab[2] == 'L' && tab[3] == '1' && tab[4] == ' ' )
									{
						tab[5]	=	uart_getc();
						if(tab[0] == 'G' && tab[1]	==	' ' && tab[2] == 'L' && tab[3] == '1' && tab[4] == ' ' && tab[5] == 'B' )
															{
							   LED_OFF_G_2;
							   LED_OFF_R_2;
							   LED_ON_B_2;
						...
						if(tab[0] == 'G' && tab[1]	==	' ' && tab[2] == 'L' && tab[3] == '1' && tab[4] == ' ' && tab[5] == 'R' )
															{
							   LED_OFF_G_2;
							   LED_ON_R_2;
							   LED_OFF_B_2;
						...
						if(tab[0] == 'G' && tab[1]	==	' ' && tab[2] == 'L' && tab[3] == '1' && tab[4] == ' ' && tab[5] == 'G' )
															{
							   LED_ON_G_2;
							   LED_OFF_R_2;
							   LED_OFF_B_2;
						...
						if(tab[0] == 'G' && tab[1]	==	' ' && tab[2] == 'L' && tab[3] == '1' && tab[4] == ' ' && tab[5] == '0' )
															{
							   LED_OFF_G_2;
							   LED_OFF_R_2;
							   LED_OFF_B_2;
				...
				if(tab[0] == 'G' && tab[1]	==	' ' && tab[2] == 'L' && tab[3] == '2')
				{
					tab[4]	=	uart_getc();
					if(tab[0] == 'G' && tab[1]	==	' ' && tab[2] == 'L' && tab[3] == '2' && tab[4] == ' ' )
									{
						tab[5]	=	uart_getc();
						if(tab[0] == 'G' && tab[1]	==	' ' && tab[2] == 'L' && tab[3] == '2' && tab[4] == ' ' && tab[5] == 'B' )
															{
							   LED_OFF_G;
							   LED_OFF_R;
							   LED_ON_B;
						...
						if(tab[0] == 'G' && tab[1]	==	' ' && tab[2] == 'L' && tab[3] == '2' && tab[4] == ' ' && tab[5] == 'R' )
															{
							   LED_OFF_G;
							   LED_ON_R;
							   LED_OFF_B;
						...
						if(tab[0] == 'G' && tab[1]	==	' ' && tab[2] == 'L' && tab[3] == '2' && tab[4] == ' ' && tab[5] == 'G' )
															{
							   LED_ON_G;
							   LED_OFF_R;
							   LED_OFF_B;
						...
						if(tab[0] == 'G' && tab[1]	==	' ' && tab[2] == 'L' && tab[3] == '2' && tab[4] == ' ' && tab[5] == '0' )
															{
							   LED_OFF_G;
							   LED_OFF_R;
							   LED_OFF_B;
